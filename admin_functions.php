...
function enrolmentFormData() 
{
	...
	document.getElementById("Title").innerHTML = "Requests for Enrolment of Subjects";
}
	...
	document.getElementById("body_description").innerHTML = "<?php 
															...
															if ($result = $infoObj->getEnrollmentFormData())
															{
																while ($obj = $result->fetch_object())
																{
																	...
																	echo "<form class='form'><h2 align='center'> Request for Enrollment of Subjects </h2>";
	...
	document.getElementById("body_description").innerHTML = "<?php 
														...
														if ($result = $infoObj->getCancelStudentPassFormData())
														{
															while ($obj = $result->fetch_object())
															{
																...
																echo "<div class='half_box'>Upload Evidence:</div><div class='half_box'><a href='pdfDownload_functions.php?Cancel_ID=$Cancel_ID'>$obj->FileName</a></div>";
	...
	document.getElementById("body_description").innerHTML = "<?php 
														...
														if ($result = $infoObj->getDeferExamFormData())
														{
															while ($obj = $result->fetch_object())
															{
																...
																echo "<div class='half_box'>Upload Evidence:</div><a href='pdfDownload_functions.php?Defer_ID=$Defer_ID'>$obj->FileName</a>";
																echo "</fieldset></form>";
															}
														}
													?>";
